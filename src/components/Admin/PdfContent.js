  ...
  return (
    <div className="p-5">
      ...
      <p>
        ...
        takes the first step towards their career selection; that is, selecting
        a suitable stream for themselves based on their aptitude and interest.
      </p>
      <p>
        The stream recommendation test becomes crucial as it helps to clear the
        ambiguity and confusion and provides a certainty of an option or a
      ...
      <div className="barchart-table-container" style={{ marginLeft: "160px" }}>
      ...
      <p>
        ...
        that is unaffected by interest. Though innate, it can still be developed
      ...
      <p>
        When deciding on a particular stream, it is important that we give equal
        importance and weightage to these factors, aptitude and interest. As
        only then a foundation to a successful career can be laid.
      </p>
      <p>
      ...
      <b>Example:</b>
      <p>
        If an individual selects a career where their aptitude is high but their
        interest levels are not very high or low, then there is a probability
        that they will find the tasks assigned to them uninteresting and so they
        will not be self motivated to continue such a career for a long time.
      </p>
      <p>
      ...
      <p>
        ...
        put in your best effort by hard work, dedication and being consistent in
        what you do.
      </p>
      <br />
      <br />
      <br />
      <p>
        <b>Remember:</b> “You can always edit a bad page. You can’t edit a blank
        page&quot;
      </p>
      <p className="text-end">- Jodi Picoult</p>
      <p>
        The recommendation provided in the report should be taken as a guide to
        help you decide on your selection of stream. It should be seen as a
